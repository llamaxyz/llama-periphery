...
contract MockERC721VotesChangingClock is ERC721, EIP712, ERC721Votes {
  bool useBlockNumber;
  ...
  function CLOCK_MODE() public view override returns (string memory) {
    return useBlockNumber ? "mode=blocknumber" : "mode=timestamp";
  }

  function clock() public view override returns (uint48) {
    return useBlockNumber ? uint48(block.number) : uint48(block.timestamp);
  }
